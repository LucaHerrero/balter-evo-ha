...
spec = importlib.util.spec_from_file_location("bp2p", INTEGRATION)
bp2p = importlib.util.module_from_spec(spec); spec.loader.exec_module(bp2p)
...
chk("HELLO76 CH0", bp2p.build_hello76(0x07,0), (0x07000003,0,76), hello=True)
chk("HELLO76 CH1", bp2p.build_hello76(0x08,1), (0x08000004,0,76), hello=True)
